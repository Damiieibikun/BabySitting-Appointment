...
function emptyFields(event) {
    if (event.target.value === '') {
        ...
        document.getElementById('error-msg').classList.remove('error-msg', 'display')
...
window.addEventListener('click', function() {
    ...
    if (numOfEmpty === 0) {
        ...
        if (validateFields()) {
            ...
            this.localStorage.setItem('Appointment-details', JSON.stringify(appointmentDetails))
            console.log('Success')
...
function bookSitter() {
    ...
    document.getElementById('service-selected').innerText = `${serviceSelected} sitters`
    ...
    // sitters info
    let listSitters = []
    let sitter1 = new Sitter(1, 'Brian', '3 years experience', 'Waiter', 'Content Creator')
    listSitters.push(sitter1)
    let sitter2 = new Sitter(2, 'Anne', '2 years experience', 'Former pre-school Teacher', 'Speaks French and Spanish')
    listSitters.push(sitter2)
    let sitter3 = new Sitter(3, 'Gabrielle', '1 year experience', 'Speech Therapist', 'Biligual')
    listSitters.push(sitter3)
    let sitter4 = new Sitter(4, 'Amaka', '2 years experience', 'Nurse', 'Speaks Igbo and Spanish')
    listSitters.push(sitter4)
    let sitter5 = new Sitter(5, 'Divine', '3 years experience', 'Student', 'Computer Science Undergard')
    listSitters.push(sitter5)
    let sitter6 = new Sitter(6, 'Santi', '3 years experience', 'Research Assistant', 'Speaks Hindi and German')
    listSitters.push(sitter6)
    let sitter7 = new Sitter(7, 'Amy', '4 years experience', 'Baby Sitter', 'Baking')
    listSitters.push(sitter7)
    let sitter8 = new Sitter(8, 'Sandra', '1 year experience', 'College Student', 'Speaks Mandirin, Cantonese, French and Italian')
    listSitters.push(sitter8)
    let sitter9 = new Sitter(9, 'Emily', '15 year experience', 'Stay Home Mom', 'Baking, Cooking and Painting')
    ...
    serviceSelected === 'Day' ? numOfSitters = listSitters.slice(0, 3) :
        serviceSelected === 'Evening' ? numOfSitters = listSitters.slice(3, 6) :
